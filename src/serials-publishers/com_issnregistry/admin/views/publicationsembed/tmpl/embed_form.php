...
?>
<form action="index.php?option=com_issnregistry&view=publicationsembed&formId=<?php echo JFactory::getApplication()->input->getInt('formId', 0); ?>&tmpl=component&layout=embed_form" method="post" id="adminForm" name="adminForm">

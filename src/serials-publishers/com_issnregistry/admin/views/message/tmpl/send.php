...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_issnregistry&layout=send&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                <button id="jform_send" class="btn btn-small"><span class="icon-save"></span><?php echo JText::_('COM_ISSNREGISTRY_MESSAGE_BUTTON_SEND'); ?></button>

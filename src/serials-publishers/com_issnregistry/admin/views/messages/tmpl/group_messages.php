...
?>
<form action="index.php?option=com_issnregistry&view=messages&groupMessageId=<?php echo JRequest::getVar('groupMessageId', 0); ?>&tmpl=component&layout=group_messages" method="post" id="adminForm" name="adminForm">

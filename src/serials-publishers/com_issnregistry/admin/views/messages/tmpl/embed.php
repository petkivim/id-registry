...
?>
<form action="index.php?option=com_issnregistry&view=messages&publisherId=<?php echo JFactory::getApplication()->input->getInt('publisherId', 0); ?>&tmpl=component&layout=embed" method="post" id="adminForm" name="adminForm">

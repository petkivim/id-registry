...
class IdRegMonoPubFormsHtmlBuilder {
    ...
    public static function getRegisterMonographPublisherForm($langTag, $errors = array()) {
        ...
        $html .= '<div><input type="text" name="question_7" id="question_7" class="question" size="30" value="' . $_POST['question_7'] . '" />';
		$html .= '<span class="error">' . JText::_($errors['question_7']) . '</span></div>';

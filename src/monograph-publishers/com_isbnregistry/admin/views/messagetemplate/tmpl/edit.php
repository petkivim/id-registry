...
$document->addScript('components/com_isbnregistry/scripts/messagetemplate_validators.js');
$document->addScript("components/com_isbnregistry/scripts/messagetemplate.js");
// Add css
...
<form action="<?php echo JRoute::_('index.php?option=com_isbnregistry&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'message', JText::_('COM_ISBNREGISTRY_MESSAGE_TEMPLATE_TAB_MESSAGE', true)); ?>
        ...
        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'info', JText::_('COM_ISBNREGISTRY_MESSAGE_TEMPLATE_TAB_INFO', true)); ?>
        <div class="row-fluid form-horizontal-desktop">

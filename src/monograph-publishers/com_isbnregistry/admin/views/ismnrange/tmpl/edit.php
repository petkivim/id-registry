...
$document->addScript('components/com_isbnregistry/scripts/ismnrange_validators.js');
$document->addScript("components/com_isbnregistry/scripts/ismnrange.js");
// Add css
...
JFactory::getDocument()->addScriptDeclaration('
    ...
    {
        if (task == "ismnrange.cancel" || document.formvalidator.isValid(document.getElementById("adminForm")))
        {
...
<form action="<?php echo JRoute::_('index.php?option=com_isbnregistry&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <input type="hidden" name="task" value="ismnrange.edit" />

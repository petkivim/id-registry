...
');
?>
<form action="index.php?option=com_isbnregistry&view=messages" method="post" id="adminForm" name="adminForm">
                ...
                <?php if (!empty($this->items)) : ?>
                    ...
                    foreach ($this->items as $i => $row) :
                        ...
                        <tr>
							...
							<td>
                                <a href="<?php echo $link; ?>" title="<?php echo JText::_('COM_ISBNREGISTRY_EDIT_MESSAGE'); ?>">

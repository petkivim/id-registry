...
?>
<form action="index.php?option=com_isbnregistry&view=publications&publisherId=<?php echo JFactory::getApplication()->input->getInt('publisherId', 0); ?>&tmpl=component&layout=embed" method="post" id="adminForm" name="adminForm">
